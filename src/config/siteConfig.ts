...
export const siteConfig: SiteConfig = {
	// 站点标题
	title: "Welcome to Yansuan's blog.",

	// 站点副标题
	subtitle: "Yanusan's personal blog, a place to share knowledge and experiences.",
	...
	// 站点描述
	description:
		"Welcome to Yansuan's blog. Here you'll find a collection of articles and thoughts on various topics.",
	// 站点关键词
	keywords: [
		"Yansuan",
		"Fuwari",
